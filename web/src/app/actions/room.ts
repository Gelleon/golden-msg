      ...
      include: {
        user: {
          select: {
            ...
            job_title_cn: true,
            last_active_at: true,
            phone: isAdminOrManager,
            telegram: isAdminOrManager,
            whatsapp: isAdminOrManager,
            wechat: isAdminOrManager,
            bio_short: isAdminOrManager,
            join_reason: isAdminOrManager,
            referred_by: isAdminOrManager,
          },
        },
      },
      orderBy: {
